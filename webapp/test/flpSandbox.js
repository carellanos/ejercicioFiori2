		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "flights",
									"targetURL": "#flightsearchflights-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"flightsearchflights-display": {
								"semanticObject": "flightsearchflights",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=flightsearch.flights",
									"url": sap.ui.require.toUrl("flightsearch/flights")
								}
							}
						}
					}
